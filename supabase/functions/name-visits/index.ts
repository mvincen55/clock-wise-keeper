        ...
        messages: [
          {
            ...
            content:
              ...
              "names: rewrite each slot label, short (2-5 words), specific and timing-first so the patient knows WHEN it's due and what it's for. Name each visit after its most significant procedure that day: 'At the Extraction Visit', 'At Crown Prep', 'At Implant Surgery' — never a vague label like 'Diagnostic Visit' or 'Treatment Visit' when real work happens that day. Name each visit for what the patient experiences that day, in everyday patient words — and follow the OFFICE WORDING RULES below exactly for any terms of art. Scheduling payments keep 'Upon Scheduling' (optionally + what's being scheduled). A payment may prepay later work — never name it after work that happens at a different visit, and NEVER invent visits or stages not in the list. Every payment name must be UNIQUE — when the same kind of visit repeats, keep the given First/Second distinction ('At the First Extraction Visit', 'At the Second Extraction Visit'), never two identical names. No 'Visit 1/2/3' numbering, codes, or prices. Exactly one name per slot, same order. " +
              `treatment: 2-3 clean sentences summarizing the whole plan, ${voiceRule}. RULES: ` +
              "(0) The doctor (or 'we') is ALWAYS the actor doing things to teeth, in active voice: 'Dr. Natalie will prepare tooth #14 for a porcelain crown, place a composite filling on tooth #15, and deliver the crown at a later visit.' NEVER 'This plan by Dr. X will…', 'The plan will…', or passive phrasing like 'Tooth #15 will receive a filling'. Use everyday words a patient says out loud — 'a later visit', never 'a subsequent visit'. " +
