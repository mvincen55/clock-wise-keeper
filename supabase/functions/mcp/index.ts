// OWNED (banner removed so the Vite plugin leaves this file alone): the plugin
// regenerated a type-unsafe bundle (untyped ctx params, unchecked process.env)
// that failed `deno check` in the edge-function release gate. This hand-owned
// copy is type-safe; re-take generation later once the plugin emits valid TS.
