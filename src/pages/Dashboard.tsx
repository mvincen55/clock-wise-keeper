    ...
    <div className="p-4 md:p-8 max-w-3xl mx-auto space-y-6">
      ...
      <Card className="card-elevated overflow-hidden">
        ...
        <CardContent className="p-6">
          ...
          {/* One contextual line after clock-in, when there's something worth
              saying. Silent otherwise — no filler. */}
          {status === 'clocked_in' && clockNudge && (
            <NudgeLine nudge={clockNudge} variant="inline" className="mb-4" />
          )}
