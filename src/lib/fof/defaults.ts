...
const FOOTNOTE_INSURANCE_ESTIMATE =
...
export const DEFAULT_TEMPLATES: FofTemplateSeed[] = [
  {
    ...
    footnotes: [FOOTNOTE_VALIDITY, FOOTNOTE_PREPAY_TERMS, FOOTNOTE_CONTACT],
  ...
  },
  {
    ...
    isActive: true,
    discountPercent: 10,
    discountLabel: 'Office Discount (Prepay discount)',
    ...
    footnotes: [
      FOOTNOTE_VALIDITY,
      FOOTNOTE_PREPAY_TERMS,
      FOOTNOTE_INSURANCE_ESTIMATE,
      FOOTNOTE_CONTACT,
    ],
    signatureIntro: DEFAULT_SIGNATURE_INTRO,
  },
  {
    ...
    isActive: true,
    discountPercent: 0,
    discountLabel: 'Office Discount (No discount with financing)',
    showInsuranceEstimate: false,
    showWriteOff: false,
    showPrepayOption: true,
    showInstallmentOption: true,
    installmentCount: 3,
    installmentLabels: DEFAULT_INSTALLMENT_LABELS,
    footnotes: [FOOTNOTE_VALIDITY, FOOTNOTE_CONTACT],
    signatureIntro: DEFAULT_SIGNATURE_INTRO,
  },
];
