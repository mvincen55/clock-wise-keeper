...
export default defineMcp({
  ...
  version: "0.1.0",
  instructions:
    "Tools for TimeVault, a workforce time tracking app. Use `whoami` to check identity, `list_time_entries` to read the caller's daily hours, and `list_pto_requests` to read their PTO requests. All tools act as the signed-in user; row-level security scopes results to that user's org and employee.",
