 ...
 * from their permission role. Members propose their own during onboarding;
 * this editor is where owners/managers confirm or change them.
 */
        ...
        <>
          {pending && (
            <Button
              ...
              onClick={() =>
                confirm.mutate(employeeId, {
                  onSuccess: () => toast.success('Roles confirmed'),
