...
import { Clock, Table2, CalendarDays, FileText, LogOut, Menu, X, Settings, ShieldCheck, Send, CheckSquare, Users, Calendar, ReceiptText, Sparkles, BookOpen, Phone, ListChecks, Banknote, Sunrise, ChevronLeft, ChevronRight, type LucideIcon } from 'lucide-react';
...
export default function AppLayout({ children }: { children: ReactNode }) {
  ...
  const renderItem = (item: NavItem, onNavigate?: () => void, mobile = false) => {
    ...
    const badge = null as React.ReactNode;
    const link = (
      <Link
        key={item.to}
        to={item.to}
